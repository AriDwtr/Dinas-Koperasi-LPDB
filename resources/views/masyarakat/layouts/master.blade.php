...
<html lang="en">
    ...
    <body data-topbar="colored" data-layout="horizontal" data-layout-size="boxed">
        ...
        <div id="layout-wrapper">
            ...
            <header id="page-topbar" class="noprint">
                <div class="navbar-header">
                    <div class="container-fluid">
                        @include('masyarakat.layouts.account')

                        <!-- LOGO -->
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="/koperasi/logo.png" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="/koperasi/logo.png" alt="" height="20">
                                </span>
                            </a>

                            <a href="index.html" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="/koperasi/logo.png" alt="" height="55">
                                </span>
                                <span class="logo-lg">
                                    <img src="/koperasi/logo.png" alt="" height="50">
                                </span>
                            </a>
                        </div>
                        ...
                        @include('masyarakat.layouts.nav')
                    </div>
                </div>
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                2022 © Dinas Koperasi Sumsel.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-right d-none d-sm-block">
                                    Crafted with <i class="mdi mdi-heart text-danger"></i> by Dinas Koperasi Sumsel
                                </div>
                            </div>
                        </div>
                    </div>
